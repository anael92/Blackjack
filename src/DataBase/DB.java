...
public class DB {
    ...
    private void fillUsers() {
        ...
        (fillUsersTable, stat.RETURN_GENERATED_KEYS);
    ...
    public void addUser(User u) {
        ...
        try {
            stat = connection.prepareStatement
        (updateUser, stat.RETURN_GENERATED_KEYS);
    ...
    public void initUsers() {
        ...
        try {
            while (resultSet.next()) {
                ...
                {
                    Admin a = new Admin
        (id, firstName, lastName, gender, userName, password);
                    users.add(a);
    ...
    public void changePassword(String newPassword, int userId) {
        ...
        String updatePassword = 
                "UPDATE APP.USERS SET PASSWORD = ? WHERE ID = ?";
        createConnection();
        try {
