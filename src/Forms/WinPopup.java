 ...
 * @author Nadav
 */
public class WinPopup extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WinPopup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
